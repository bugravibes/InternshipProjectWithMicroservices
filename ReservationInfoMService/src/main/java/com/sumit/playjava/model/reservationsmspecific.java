...
@Entity
public class reservationsmspecific {
	public reservationsmspecific() {
	}

	public reservationsmspecific(int reservationId, int flightId, String name, String surname, String birthDate,
