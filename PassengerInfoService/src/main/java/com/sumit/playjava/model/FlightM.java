...
public class FlightM {
	...
	public String toString() {
		return "FlightM [flightId=" + flightId + ", businessCapacity=" + businessCapacity + ", businessPriceAdult="
				+ businessPriceAdult + ", businessPriceChild=" + businessPriceChild + ", businessPriceInfant="
				+ businessPriceInfant + ", economyCapacity=" + economyCapacity + ", economyPriceAdult="
				+ economyPriceAdult + ", economyPriceChild=" + economyPriceChild + ", economyPriceInfant="
				+ economyPriceInfant + ", plane=" + plane + ", company=" + company + ", fromPort=" + fromPort
				+ ", toPort=" + toPort + ", flightDate=" + flightDate + ", flightTime=" + flightTime + ", arrivalTime="
				+ arrivalTime + ", fromPortCode=" + fromPortCode + ", toPortCode=" + toPortCode + "]";
	}
